package eapli.base.emailHandler;
...
public class EmailHandler {
    ...
    public EmailHandler() throws IOException {
        ...
        String propFileName = "ecafeteria.sample.properties";
        ...
        username = appProperties.getProperty("email.from", "g022dklapr4@gmail.com");
        final String password = appProperties.getProperty("email.password", "naoSeiquepassUsar123");
