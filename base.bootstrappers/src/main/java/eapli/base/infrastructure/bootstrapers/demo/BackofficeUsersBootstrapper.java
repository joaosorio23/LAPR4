...
//        registerMenuManager("chef", PASSWORD1, "Master", "Chef", "master.chef@emai.l.com");
          registerResponsavelRecusrosHumanos("rrh",PASSWORD1,"Miguel","Oliveira","rrh@gmail.com");
        return true;
    }
...
//    }
    ...
    private void registerResponsavelRecusrosHumanos(final String username, final String password,final String firstName, final String lastName, final String email) {
